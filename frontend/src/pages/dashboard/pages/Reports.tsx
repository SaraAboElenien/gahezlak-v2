...
import { useShopReports } from "@/hooks/useReports";
...
export default function Reports() {
  const { data, isLoading } = useShopReports();
  ...
  //     "data": [
  //         {
  //             "_id": "68841ae205980c45201b1893",
  //             "senderName": "Ahmed",
  //             "senderEmail": "ahmed@example.com",
  //             "shopId": "6877d741e71bc6bbfa750034",
  //             "receiver": "shop_owner",
  //             "message": "There was a problem with my order #123",
  //             "orderNumber": 123,
  //             "createdAt": "2025-07-26T00:01:38.343Z",
  //             "updatedAt": "2025-07-26T00:01:38.343Z",
  //             "__v": 0
  //         },
  //         {
  //             "_id": "6883130154b27af08c62990a",
  //             "senderName": " Ali hassan",
  //             "senderEmail": "ali@example.com",
  //             "shopId": "6877d741e71bc6bbfa750034",
  //             "receiver": "shop_owner",
  //             "message": "I really like your shop, but I had a small issue with the login.",
  //             "createdAt": "2025-07-25T05:15:45.560Z",
  //             "updatedAt": "2025-07-25T05:15:45.560Z",
  //             "__v": 0
  //         }
  //     ]
  // }
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-100 dark:bg-gray-800">
              <tr className="text-sm text-gray-500 uppercase">
                ...
                <th className="px-6 py-3 text-left">{t("orderNumber")}</th>
                <th className="px-6 py-3 text-left">
                  {t("adminReports.date")}
                </th>
                <th className="px-6 py-3 text-left">
              ...
              {(data?.data?.length ?? 0) > 0 ? (
                ...
                (data!.data as unknown as Report[]).map((report) => (
                  <tr key={report._id}>
                    ...
                    <td className="px-6 py-4">{report.orderNumber}</td>
                    ...
                    <td className="px-6 py-4">
                      <button
                        className="btn btn-ghost btn-sm text-primary hover:animate-bounce border-0 bg-primary/20"
