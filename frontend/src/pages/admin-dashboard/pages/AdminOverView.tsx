...
const AdminOverView = () => {
  ...
  const { data: topRestaurantsData, isLoading: isTopRestaurantsLoading } =
    useTopRestaurants(topRestaurantsParams);

  const { data: revenueGrowthData, isLoading: isRevenueGrowthLoading } =
    useRevenueGrowth(revenueGrowthParams);

  const { data: totalRevenueData, isLoading: isTotalRevenueLoading } =
    useAdminTotalRevenue(totalRevenueParams);
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-base-content/60">
                          {t("fromToDate", {
                            start: totalRevenueParams.startDate,
                            end: totalRevenueParams.endDate,
                          })}
                        </p>
                      </div>
                    ...
                    {isRevenueGrowthLoading ? (
                      ...
                      <>
                        <div>
                          ...
                          <p
                            className={`mt-2 text-sm font-medium ${textColor}`}
                          >
                            {label}
                          </p>
                        </div>
